    ...
    <v-card-text>
      ...
      >
        <template v-slot:top>
          ...
          >
            <v-text-field
              v-show="object.id && tipoPessoa!='visitante'"
              v-model="search"
              type="text"
                      ...
                      <v-row>
                        ...
                        >
                          ...
                          <div v-if="disabled">
                            ...
                            <pdf-viewer
                              v-if="isPdfFile(documento.preview)"
                              :file="documento.preview"
                            />
                            <v-img
                              v-else
...
export default {
  components: { SimpleDialog, ConfirmDialog, PdfViewer },
